...
\vspace{3cm}
\title{Remote Control Toy Car Using Arduino Uno}
\maketitle
\newpage
\bigskip
...
\begin{abstract}
This document shows how to implement remote controlled toy car using arduino.
\end{abstract}
\section{Components Required:}
\begin{enumerate}
    \item Arduino board
    \item Car with Motors
...
Arduino/IDE/MotorControl/Figures/pin.jpg
    ...
    \item  The input and enable pins(ENA, IN1, IN2, IN3, IN4 and ENB) of the L293D IC are connected to six Arduino digital output pins(9, 8, 7, 5, 4 and 3).
