 ...
 *
 *    File   : main.c
 *    Purpose: Navigating UGV using Android phone (Vaman)
 *                                                          
 *=========================================================*/
...
int main(void)
{
   ...
   // dbg_str("\n\nHello GPIO!!\n\n"); // <<<<<<<<<<<<<<<<<<<<<  Change me!
    ...
    //LED pins Output
    PyHal_GPIO_SetDir(26, 0);   //input pins for taking input from ESP32
    PyHal_GPIO_SetDir(11, 0);	
    PyHal_GPIO_SetDir(12, 0);

    PyHal_GPIO_SetDir(4, 1);	//output pins for motor direction control
  ...
  while(1)
  {
   ...
   else if((PyHal_GPIO_Get(11)==0 && PyHal_GPIO_Get(12)==0) && PyHal_GPIO_Get(26)==1 )
	Back();
   
   else if(PyHal_GPIO_Get(11)==0 && PyHal_GPIO_Get(12)==1)
 	Right();

   else if(PyHal_GPIO_Get(11)==1 && PyHal_GPIO_Get(12)==0)
	Left();
